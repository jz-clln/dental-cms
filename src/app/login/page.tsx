...
function LoginContent() {
  ...
  // Switch view — always clear errors
  ...
  const titles: Record<View, { heading: string; sub: string }> = {
    login:  { heading: 'Welcome back',         sub: 'Sign in to your clinic account' },
    forgot: { heading: 'Reset your password',  sub: "Enter your email and we'll send a reset link" },
    sent:   { heading: 'Check your inbox',     sub: `We sent a link to ${forgotEmail}` },
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">{titles[view].heading}</h1>
          <p className="text-gray-500 text-sm mt-1">{titles[view].sub}</p>
        </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="you@clinic.com"
                    className="w-full pl-9 pr-3.5 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-900
                      placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500
                      focus:border-transparent transition-colors hover:border-gray-300"
                  />
                </div>
          ...
          {view === 'sent' && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-400 text-center">
                ...
                <button
                  onClick={() => { setForgotEmail(''); switchView('forgot'); }}
